...
class TestBlockChain:
    ...
    def test_blockchain_get_last_with_multiple_blocks(self):
        ...
        genesis_block = Block(0, "2025-07-15T12:00:00", [], "0", "Genesis")
        block1 = Block(1, "2025-07-15T12:01:00", [], "Genesis", "abc123")
        block2 = Block(2, "2025-07-15T12:02:00", [], "abc123", "def456")
    ...
    def test_blockchain_add_block(self):
        ...
        new_block = Block(1, "2025-07-15T12:01:00", [], "Genesis", "abc123")
        blockchain.add_block(new_block)
        
        assert len(blockchain.blocks) == 2
        assert blockchain.blocks[1] == new_block
    ...
    def test_blockchain_add_block_wrong_previous_hash(self):
        ...
        new_block = Block(1, "2025-07-15T12:01:00", [], "WrongHash", "abc123")
    ...
    def test_blockchain_add_block_updates_index(self):
        """Test that adding a block updates the index correctly"""
        genesis_block = Block(0, "2025-07-15T12:00:00", [], "0", "Genesis")
        blockchain = BlockChain([genesis_block], genesis_block)
        ...
        # The added block should have index 2 (genesis is 0, first block is 1, this is 2)
        assert blockchain.blocks[1].index == 2 